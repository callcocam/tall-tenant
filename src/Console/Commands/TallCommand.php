...
class TallCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $path = __DIR__.'/stubs/fortity-create-new-user.stub';
        ...
        $path = __DIR__.'/stubs/model-user.stub';
        if(file_exists(base_path('stubs/model-user.stub'))){
            $path = base_path('stubs/model-user.stub');
        }
        File::put(app_path('Models/User.php'), file_get_contents($path));


        $path = __DIR__.'/stubs/pagination-blade.stub';
        if(file_exists(base_path('stubs/pagination-blade.stub'))){
            $path = base_path('stubs/pagination-blade.stub');
        }
        File::put(resource_path('views/vendor/livewire/pagination.blade.php'), file_get_contents($path));
